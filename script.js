...
const data = {
    nationality: ["Brazillian", "Arctic", "Russian", "Maine", "Roumanian", "Turkish style", "Argentinian", "Madagascarian style", "Alaskan", "Philippino", "Japanese", "Chinese", "Norweigian style", "Ethiopian style", "South African", "French", "Spanish", "Greek", "Dubai-style", "Floridian", "Californian", "Pacific", "Local", "Wild"],
    ...
    sideDish: ["panzanella", "sweetbreads", "head cheese", "organic omelet", "fricasse", "ratatouille", "baba ganoush", "polenta", "chili", "taco", "granita", "parmesan-herb", "mache", "ricotta salata"],
